...
<body>
	...
	<div class="container">
		...
		<div class="search_list">
			<ul>
				<li class="all">
					<input class="ng-all"type="text" placeholder="고객명" >
				...
				<li>
					<select name="ng-valid" class="ng-valid">
		...
		<div class="search_mt">
			...
			<div class="right">
				<a class="on" href="#">등록일 순</a>
				<a class="on" href="#">고객사 순</a>
				<a class="on default" href="#">가나다 순</a>
			</div>
		</div>
	</div>
		<hr>
